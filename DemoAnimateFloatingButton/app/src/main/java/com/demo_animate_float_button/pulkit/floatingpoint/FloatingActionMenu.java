package com.demo_animate_float_button.pulkit.floatingpoint;
...
import com.demo_animate_float_button.pulkit.R;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsShowAnimation = attr.getResourceId(R.styleable.FloatingActionMenu_menu_labels_showAnimation,
                mLabelsPosition == LABELS_POSITION_LEFT ? R.anim.fab_slide_in_from_left : R.anim.fab_slide_in_from_right);
